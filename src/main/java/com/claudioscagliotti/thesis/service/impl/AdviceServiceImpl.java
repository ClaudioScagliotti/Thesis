...
public class AdviceServiceImpl implements AdviceService {
     ...
     */
    public AdviceServiceImpl(AdviceRepository adviceRepository, AdviceMapper adviceMapper, GoalServiceImpl goalService,
                             TmdbApiClient client, MovieMapper movieMapper, MovieServiceImpl movieService,
                             UserRepository userRepository, GenreServiceImpl genreService, UserServiceImpl userService, UserStatsServiceImpl userStatsService, BadgeServiceImpl badgeService) {
