...
public class LessonProgressServiceImpl implements LessonProgressService {
     ...
     */
    public LessonProgressServiceImpl(LessonProgressRepository lessonProgressRepository, LessonRepository lessonRepository,
                                     UserServiceImpl userService, LessonProgressMapper lessonProgressMapper) {
     ...
     */
    public void createLessonProgress(UserEntity userEntity, Long lessonId, Integer newCompletedCard) {
        Optional<LessonEntity> lessonEntity = lessonRepository.findById(lessonId);
